...
const associates = [
  ...
  },
  {
    ...
    bio:
      'Egresado de la Escuela Libre de Derecho. Se especializa en las áreas bursátiles, bancaria y financiera tanto a nivel nacional como internacional. Fue abogado en la Dirección de Disposiciones de Banca Central de Banco de México para operaciones de cambios internacionales, metales, deuda pública externa y control de cambios. Durante nueve años trabajó en Mijares, Angoitia, Cortés y Fuentes y en Fried, Frank, Harris, Shriver & Jacobson, dos importantes firmas en México y Nueva York. Fue socio fundador y socio encargado del área financiera de Romo, Paillés y Guzmán, S.C. durante más de 10 años. Como abogado en México y en Nueva York ha participado en un gran número de operaciones en el mercado de capitales durante los últimos 20 años, incluyendo ofertas públicas y privadas de deuda o capital en la Bolsa Mexicana de Valores y la Bolsa de Valores de Nueva York y otros mercados internacionales, asesorando a intermediarios, emisores, bancos de inversión, agencias calificadoras y otros participantes en diversas operaciones de financiamiento bursátil. Asimismo, cuenta con una amplia experiencia en el área de fusiones y adquisiciones, así como reestructuraciones crediticias y aspectos corporativos de carácter general.',
  },
  {
